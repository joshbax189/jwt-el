...
(ert-deftest jwt-hs256/test ()
  ...
  (should (equal
           ...
           (byte-string-to-hex (jwt-hs256 (encode-coding-string "The quick brown fox jumps over the lazy dog" 'ascii) (encode-coding-string "key" 'ascii))))))

(ert-deftest jwt-hs256/test-utf-8 ()
  "correctness"
  (should (equal
           "a816481d563291d584bf019c50e4143def701d72952dc3bbab32e2c5178c1651"
           (byte-string-to-hex (jwt-hs256 (encode-coding-string "家" 'utf-8) (encode-coding-string "key" 'ascii)))))
  (should (equal
           "c280cd885e9434858bdd8513cea6a99c90925b3f67b16896cb6bc25f50abe15d"
           (byte-string-to-hex (jwt-hs256 (encode-coding-string "foobar123" 'ascii) (encode-coding-string "家" 'utf-8))))))

(ert-deftest jwt-hs512/test ()
  "correctness"
  (should (equal
           "b42af09057bac1e2d41708e48a902e09b5ff7f12ab428a4fe86653c73dd248fb82f948a549f7b791a5b41915ee4d1ec3935357e4e2317250d0372afa2ebeeb3a"
           (byte-string-to-hex (jwt-hs512 (encode-coding-string "The quick brown fox jumps over the lazy dog" 'ascii) (encode-coding-string "key" 'ascii))))))
...
(ert-deftest jwt-hs512/test-utf-8 ()
  ...
  (should (equal
           ...
           (byte-string-to-hex (jwt-hs512 (encode-coding-string "家" 'utf-8) (encode-coding-string "key" 'ascii)))))
  (should (equal
           ...
           (byte-string-to-hex (jwt-hs512 (encode-coding-string "foobar123" 'ascii) (encode-coding-string "家" 'utf-8))))))

(ert-deftest byte-string-to-hex/test ()
  "Check, as this is used in tests."
  (should (equal "f7bc83f430538424b13298e6aa6fb143ef4d59a14946175997479dbc2d1a3cd8"
                 (byte-string-to-hex (hex-string-to-bytes "f7bc83f430538424b13298e6aa6fb143ef4d59a14946175997479dbc2d1a3cd8"))))
  (should (equal "08"
                 (byte-string-to-hex (string 8)))))
